...
exports.exec = (msg, args, sandboxed) =>
{
  ...
  if (msg.author.id !== sandboxed.ownerid) {console.log(msg.author.id + " (" + msg.author.displayName +") was trying to perform eval in " + msg.guild + "!");msg.reply(":x: You are not permitted to use this Command!"); return false;}
  try {
